...
declare class TWTRAPIClient extends NSObject {
	...
	URLRequestWithMethodURLParametersError(method: string, URLString: string, parameters: NSDictionary<any, any>): NSURLRequest;

	initWithUserID(userID: string): this;

	loadTweetWithIDCompletion(tweetID: string, completion: (p1: TWTRTweet, p2: NSError) => void): void;

	loadTweetsWithIDsCompletion(tweetIDStrings: NSArray<any>, completion: (p1: NSArray<TWTRTweet>, p2: NSError) => void): void;
...
declare class TWTRCardConfiguration extends NSObject {

	static alloc(): TWTRCardConfiguration; // inherited from NSObject

	static appCardConfigurationWithPromoImageIPhoneAppIDIPadAppIDGooglePlayAppID(promoImage: UIImage, iPhoneAppID: string, iPadAppID: string, googlePlayAppID: string): TWTRCardConfiguration;

	static new(): TWTRCardConfiguration; // inherited from NSObject

	readonly cardDescription: string;

	readonly cardTitle: string;

	readonly cardType: TWTRCardType;

	readonly image: UIImage;
}

declare const enum TWTRCardType {
...
declare class TWTRComposerTheme extends NSObject {

	static alloc(): TWTRComposerTheme; // inherited from NSObject

	static new(): TWTRComposerTheme; // inherited from NSObject

	constructor(o: { themeType: TWTRComposerThemeType; });

	initWithThemeType(type: TWTRComposerThemeType): this;
}

declare const enum TWTRComposerThemeType {
...
declare class TWTRComposerViewController extends UIViewController {
	...
	hashtags: NSArray<any>;

	theme: TWTRComposerTheme;

	constructor(o: { userID: string; });

	constructor(o: { userID: string; cardConfiguration: TWTRCardConfiguration; });

	initWithUserID(userID: string): this;

	initWithUserIDCardConfiguration(userID: string, cardConfig: TWTRCardConfiguration): this;
}
...
declare class TWTRLogInButton extends UIButton {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): TWTRLogInButton; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): TWTRLogInButton; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): TWTRLogInButton; // inherited from UIAppearance
...
declare const enum TWTRLoginMethod {

	SystemAccounts = 1,

	WebBased = 2,

	WebBasedForceLogin = 4,
...
declare class TWTRMoPubNativeAdContainerView extends UIView implements UIAppearanceContainer {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): TWTRMoPubNativeAdContainerView; // inherited from UIAppearance
	...
	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): TWTRMoPubNativeAdContainerView; // inherited from UIAppearance
...
declare var TWTRMoPubSampleAdUnitID: string;
...
declare class TWTRSearchTimelineDataSource extends NSObject implements TWTRTimelineDataSource {
	...
	constructor(o: { searchQuery: string; APIClient: TWTRAPIClient; languageCode: string; maxTweetsPerRequest: number; });
	...
	initWithSearchQueryAPIClientLanguageCodeMaxTweetsPerRequest(searchQuery: string, client: TWTRAPIClient, languageCode: string, maxTweetsPerRequest: number): this;
...
interface TWTRTimelineDelegate extends NSObjectProtocol {
	...
	timelineDidFinishLoadingTweetsError?(timeline: TWTRTimelineViewController, tweets: NSArray<any>, error: NSError): void;
}
...
declare class TWTRTweet extends NSObject implements NSCoding, TWTRJSONConvertible {
	...
	static tweetsWithJSONArray(array: NSArray<any>): NSArray<any>;
...
declare class TWTRTweetDetailViewController extends UIViewController {

	static alloc(): TWTRTweetDetailViewController; // inherited from NSObject

	static new(): TWTRTweetDetailViewController; // inherited from NSObject

	actionBarInset: number;

	backgroundColor: UIColor;

	delegate: TWTRTweetDetailViewControllerDelegate;
...
interface TWTRTweetDetailViewControllerDelegate extends NSObjectProtocol {

	tweetDetailViewControllerDidTapCashtag?(controller: TWTRTweetDetailViewController, cashtag: TWTRTweetCashtagEntity): void;

	tweetDetailViewControllerDidTapHashtag?(controller: TWTRTweetDetailViewController, hashtag: TWTRTweetHashtagEntity): void;

	tweetDetailViewControllerDidTapProfileImageForUser?(controller: TWTRTweetDetailViewController, user: TWTRUser): void;

	tweetDetailViewControllerDidTapURL?(controller: TWTRTweetDetailViewController, URL: NSURL): void;

	tweetDetailViewControllerDidTapUserMention?(controller: TWTRTweetDetailViewController, userMention: TWTRTweetUserMentionEntity): void;
}
declare var TWTRTweetDetailViewControllerDelegate: {

	prototype: TWTRTweetDetailViewControllerDelegate;
};

declare class TWTRTweetEntity implements NSCoding, NSCopying, TWTRJSONConvertible {
...
declare class TWTRTweetTableViewCell extends UITableViewCell {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): TWTRTweetTableViewCell; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): TWTRTweetTableViewCell; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): TWTRTweetTableViewCell; // inherited from UIAppearance
...
declare class TWTRTweetView extends UIView implements UIAppearanceContainer {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject>): TWTRTweetView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): TWTRTweetView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject>): TWTRTweetView; // inherited from UIAppearance
...
interface TWTRTweetViewDelegate extends NSObjectProtocol {
	...
	tweetViewShouldDisplayDetailViewController?(tweetView: TWTRTweetView, controller: TWTRTweetDetailViewController): boolean;
}
...
declare class Twitter extends NSObject {

	static alloc(): Twitter; // inherited from NSObject

	static new(): Twitter; // inherited from NSObject

	static sharedInstance(): Twitter;
	...
	logInWithMethodsCompletion(methods: TWTRLoginMethod, completion: (p1: TWTRSession, p2: NSError) => void): void;

	logInWithViewControllerCompletion(viewController: UIViewController, completion: (p1: TWTRSession, p2: NSError) => void): void;

	logInWithViewControllerMethodsCompletion(viewController: UIViewController, methods: TWTRLoginMethod, completion: (p1: TWTRSession, p2: NSError) => void): void;
